...
> 我们使用了 CodeSandbox 来保证示例的公正性。在这个例子中，我们使用 Rollup-Web 打包了 brotli-wasm 这个库，并直接使用!
> 但是 CodeSandbox 不支持很多的 JS 模块特性，所以我们比较推荐使用　 PlayGround 进行练习。

<Embed
    src="___"
    id="brave-resonance-ylqxpf"
    type="codesandbox"
    autoheight="true"
></Embed>
